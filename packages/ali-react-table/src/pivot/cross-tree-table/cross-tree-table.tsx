...
import { CellProps, ColWithRenderInfo, ArtColumn, SortItem } from '../../interfaces'
...
export default class CrossTreeTable extends React.Component<CrossTreeTableProps, { openKeys: string[] }> {
  ...
  onChangeOpenKeys = (nextOpenKeys: string[], key: string, action: string) => {
    this.props.onChangeOpenKeys(nextOpenKeys, key, action)
